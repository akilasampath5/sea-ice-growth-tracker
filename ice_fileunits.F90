...
!=======================================================================
      ...
      integer (kind=int_kind) :: &
         ...
         nu_dump_thickchng   , &  ! dump file for restarting ice volume thickness change tracer
         nu_restart_thickchng, &  ! restart input file for ice volume thickness chnage tracer
...
!  nu_nml is obtained separately.
         ...
         nu_dump_thickchng    = shr_file_getUnit()
         nu_restart_thickchng = shr_file_getUnit()
         ...
         call get_fileunit(nu_dump_thickchng)
         call get_fileunit(nu_restart_thickchng)
...
!  This routine releases unit numbers at the end of a run. 
      ...
      call release_fileunit(nu_dump_thickchng)
      call release_fileunit(nu_restart_thickchng)
